!(function (e) {
            ...
            o(e, function (e, r, n, o, i) {
                ...
                switch (s) {
                    ...
                    case "Polygon":
                        if (
                            !1 ===
                            t(Object(l.b)(e, n, { bbox: o, id: i }), r, 0)
                        )
                            return !1;
                        return;
                }
        ...
        function u(e, t, r) {
            ...
            return (
                a(e, function (e, i, s, a, u) {
                    (n = !1 === o && void 0 === r ? e : t(n, e, i, s, a, u)),
                        (o = !0);
                }),
                n
            );
    ...
    function (e, t, r) {
        ...
        (L.Control.Measure = L.Control.extend({
            ...
            onRemove: function (e) {
                e.off("click", this._collapse, this),
                    e.removeLayer(this._layer);
            },
            _initLayout: function () {
                var e = this._className,
                    t = (this._container = L.DomUtil.create(
                        "div",
                        e + " leaflet-bar"
                    ));
            ...
            _collapse: function () {
                this._locked ||
                    (f.hide(this.$interaction), f.show(this.$toggle));
            },
            ...
            _startMeasure: function () {
                (this._locked = !0),
                    (this._measureVertexes = L.featureGroup().addTo(
                        this._layer
                    )),
                        ...
                        ? ((t = L.polyline(
                          ...
                          (r = _({
                              model: L.extend(
                                  {},
                                  n,
                                  this._getMeasurementDisplayStrings(n)
                              ),
                          })))
                        : ((t = L.polygon(
                              e,
            ...
            _handleMeasureClick: function (e) {
                ...
                (r && t.equals(r)) ||
                    ...
                    this._measureVertexes.eachLayer(function (e) {
                        e.setStyle(n),
                            e._path &&
                                e._path.setAttribute("class", n.className);
                    }),
    ...
    function (e, t, r) {
        var n = r(53),
            ...
            u = n(
                ...
                : function (e) {
                      return (
                          o(e) && s.call(e, "callee") && !a.call(e, "callee")
                      );
                  };
        e.exports = u;
    },
    ...
    function (e, t, r) {
        ...
        function s(e) {
            var t = e[e.length - 1],
                ...
                s =
                    1e3 *
                    (0, u.default)(n.toGeoJSON(), { units: "kilometers" }),
    ...
    function (e, t, r) {
        ...
        function n(e, t, r) {
            ...
            return Object(i.g)(
                2 * Math.atan2(Math.sqrt(p), Math.sqrt(1 - p)),
                n
            );
        }
        var o = r(83),
    ...
    function (e, t, r) {
        ...
        var o = (function () {
            ...
            s = (function () {
                function e(t) {
                    n(this, e),
                        (this._options = L.extend({}, i, this._options, t));
                }
                return (
                    o(e, [
                        {
