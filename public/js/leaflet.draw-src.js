...
(function (window, document, undefined) {
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        _calculateFinishDistance: function (potentialLatLng) {
            ...
            if (this._markers.length > 0) {
                ...
                lastPtDistance =
                    lastMarkerPoint.distanceTo(potentialMarkerPint);
            } else {
        ...
        _updateFinishHandler: function () {
            ...
            if (markerCount > 1) {
                this._markers[markerCount - 1].on(
                    "click",
                    this._finishShape,
                    this
                );
        ...
        _drawGuide: function (pointA, pointB) {
            ...
            for (; i < length; i += this.options.guidelineDistance) {
                ...
                dashPoint = {
                    x: Math.floor(
                        pointA.x * (1 - fraction) + fraction * pointB.x
                    ),
                    y: Math.floor(
                        pointA.y * (1 - fraction) + fraction * pointB.y
                    ),
                };
        ...
        _updateGuideColor: function (color) {
            if (this._guidesContainer) {
                for (
                    ...
                    this._guidesContainer.childNodes[i].style.backgroundColor =
                        color;
                }
            }
        },
    ...
    L.Draw.Rectangle = L.Draw.SimpleShape.extend({
        ...
        _getTooltipText: function () {
            var tooltipText =
                    L.Draw.SimpleShape.prototype._getTooltipText.call(this),
                shape = this._shape,
    ...
    L.Edit.PolyVerticesEdit = L.Handler.extend({
            ...
            if (poly.options.poly) {
                ...
                if (!poly.options.poly.allowIntersection && poly.intersects()) {
                    ...
                    setTimeout(function () {
                        ...
                        if (tooltip) {
                            tooltip.updateContent({
                                text: L.drawLocal.edit.handlers.edit.tooltip
                                    .text,
                                subtext:
        ...
        _onMarkerClick: function (e) {
            var minPoints =
                    L.Polygon && this._poly instanceof L.Polygon ? 4 : 3,
                marker = e.target;
    ...
    L.Map.TouchExtend = L.Handler.extend({
        ...
        _touchEvent: function (e, type) {
            ...
            var containerPoint =
                    this._map.mouseEventToContainerPoint(touchEvent),
    ...
    L.Util.extend(L.LineUtil, {
        ...
        _checkCounterclockwise: function (
            /*Point*/ p,
            /*Point*/ p1,
            /*Point*/ p2
        ) {
        ...
        onAdd: function (map) {
            ...
            for (var toolbarId in this._toolbars) {
                if (this._toolbars.hasOwnProperty(toolbarId)) {
                    toolbarContainer =
                        this._toolbars[toolbarId].addToolbar(map);
    ...
    L.DrawToolbar = L.Toolbar.extend({
        ...
        setOptions: function (options) {
            ...
            for (var type in this._modes) {
                if (
                    this._modes.hasOwnProperty(type) &&
