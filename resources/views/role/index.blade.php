...
@can('role_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('app.roles.create') }}">
                    ...
                    @foreach($roles as $key => $role)
                        <tr data-entry-id="{{ $role->id }}">
                            ...
                            <td>
                                ...
                                @can('role_delete')
                                    <form action="{{ route('app.roles.destroy', $role->id) }}" method="POST" onsubmit="return confirm('Apakah Anda Yakin ?');" style="display: inline-block;">
    ...
    $(function () {
        ...
        @can('role_delete')
            ...
            let deleteButton = {
                ...
                url: "{{ route('app.roles.massDestroy') }}",
