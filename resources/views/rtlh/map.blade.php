        ...
        var marker = L.geoJSON(geoJsonData, {
            pointToLayer: function(geoJsonPoint, latlng) {
                return L.marker(latlng).bindPopup(function (layer) {
                    return layer.feature.properties.name + '<br>ID: ' + layer.feature.properties.id + '<br>Alamat: ' + layer.feature.properties.address + '<br>Kategori Rumah: ' + layer.feature.properties.status;
                });
            }
        });
