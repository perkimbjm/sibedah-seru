        ...
        <ul class="sidepanel-tabs">
          <li class="sidepanel-tab">
            <a href="#" class="sidebar-tab-link" role="tab" data-tab-link="tab-1">
              <svg xmlns="https://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
          ...
          <li class="sidepanel-tab">
            <a href="#" class="sidebar-tab-link" role="tab" data-tab-link="tab-2">
              <svg xmlns="https://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-geo" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
          ...
          <li class="sidepanel-tab">
            <a href="#" class="sidebar-tab-link" role="tab" data-tab-link="tab-3">
              <svg xmlns="https://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                <path
          ...
          <li class="sidepanel-tab">
            <a href="#" class="sidebar-tab-link" role="tab" data-tab-link="tab-4">
              <svg xmlns="https://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bookmarks" viewBox="0 0 16 16">
                <path
          ...
          <li class="sidepanel-tab">
            <a href="#" class="sidebar-tab-link" role="tab" data-tab-link="tab-5">
              <svg xmlns="https://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
