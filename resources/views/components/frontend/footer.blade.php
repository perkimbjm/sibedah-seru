<footer class="font-poppins">
  <div class="mx-auto px-8 md:px-16 lg:px-24 pt-16 pb-4">
      <div class="flex flex-col lg:flex-row mb-20">
          <div class="lg:w-1/2 mb-10 lg:mb-0">
              <div class="flex items-center justify-center">
                  <img src="{{ asset('img/logobalangan.webp') }}" alt="logo sibedah-seru" class="mb-4 h-14 mr-2">
                  <img src="{{ asset('img/si-aldo4.png') }}" alt="logo sibedah-seru" class="mb-4 h-10 mr-2">
              </div>
              <p class="text-gray-800 text-md text-left md:text-center font-semibold space-y-2">
                ...
                Rakyat dan Kawasan Permukiman Kabupaten Balangan<br class="hidden sm:block" />
              </p>
              <p class="text-gray-800 text-sm lg:text-md text-left md:text-center space-y-2">
                Jl. Achmad Yani Km 4,5 Kel.Batupiring Kec. Paringin Selatan 71618 Kab. Balangan
               Kalimantan Selatan<br>Telp +628 xxxxxxx Email @gmail.com</p>
          </div>
          <div class="lg:w-1/2">
              <div class="flex flex-wrap -mx-3">
                  <div class="w-full lg:w-7/12 px-6 mb-6 lg:mb-0">
                      <h5 class="text-lg font-semibold mb-4">Tautan Terkait</h5>
                      <nav class="space-y-2">
                          <a href="https://balangankab.go.id/" target="_blank" class="block text-gray-600 hover:text-green-600 transition-colors duration-200">Portal Pemerintah Kab. Balangan</a>
                          <a href="https://sippn.menpan.go.id/instansi/172002/pemerintah-kab-balangan/dinas-pekerjaan-umum--penataan-ruang-perumahan-rakyat-dan-kawasan-permukiman" target="_blank" class="block text-gray-600 hover:text-green-600 transition-colors duration-200">Pelayanan Publik</a>
                          <a href="https://www.kularakat.com/home" target="_blank" class="block text-gray-600 hover:text-green-600 transition-colors duration-200">Kula Rakat</a>
                          <a href="http://geoportal.balangankab.go.id/WebPortal/index.html" target="_blank" class="block text-gray-600 hover:text-green-600 transition-colors duration-200">Geoportal Balangan</a>
                      </nav>
                  </div>
                  <div class="w-full lg:w-5/12 px-6">
                      <h5 class="text-lg font-semibold mb-4">Support</h5>
                      <nav class="space-y-2">
                          <a href="#" class="block text-gray-600 hover:text-green-600 transition-colors duration-200" data-bs-toggle="modal" data-bs-target="#contact">Contact Support</a>
                          <a href="{{ url('/') }}#faq" class="block text-gray-600 hover:text-green-600 transition-colors duration-200">FAQ</a>
                          <a href="https://www.lapor.go.id/instansi/pemerintah-kabupaten-balangan" class="block text-gray-600 hover:text-green-600 transition-colors duration-200" target="_blank">Layanan LAPOR !</a>
                          <a href="#" class="block text-gray-600 hover:text-green-600 transition-colors duration-200" data-bs-toggle="modal" data-bs-target="#disclaimer">Disclaimer</a>
                      </nav>
                  </div>
              </div>
          </div>
  ...
  <div class="py-4">
    <div class="mx-auto">
        <div class="text-center text-gray-600">
            Copyright &copy; 2024 All rights reserved | Dikayuh Baimbai
        </div>
    </div>
  </div>
