...
/* Basemap Layers */
export const cartoLight = L.tileLayer(
...
export const googleMaps = L.tileLayer(
...
export const cartoDark = L.tileLayer(
...
export const cartoVoyager = L.tileLayer(
